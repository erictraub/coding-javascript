app.controller('HomeController', function($scope, HomeFactory) {
	...
	$scope.videos = [
		...
		{title: 'Introduction to Binary Search Trees', image: "url('/assets/bstIntroImg.png')", videoLink: 'https://www.youtube.com/watch?v=Alp_Nc8Ewc0'},
		...
		{title: 'Introduction to Recursion', image: "url('/assets/recursionImg.png')", videoLink: 'https://www.youtube.com/watch?v=Y3phDUYMuI8'},
